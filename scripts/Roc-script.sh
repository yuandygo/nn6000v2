# 修改默认IP & 固件名称 & 编译署名和时间
sed -i 's/192.168.192.1/192.168.2.1/g' package/base-files/files/bin/config_generate
sed -i "s/hostname='.*'/hostname='ydy'/g" package/base-files/files/bin/config_generate
sed -i "s#_('Firmware Version'), (L\.isObject(boardinfo\.release) ? boardinfo\.release\.description + ' / ' : '') + (luciversion || ''),# \
            ...
            E('span', {}, [\n \
                ...
                : '') + (luciversion || '') + ' / ',\n \
            E('a', {\n \
                href: 'https://github.com/yuandygo/nn6000v2/releases',\n \
                target: '_blank',\n \
...
git clone --depth=1 https://github.com/nikkinikki-org/OpenWrt-nikki.git packag/OpenWrt-nikki
